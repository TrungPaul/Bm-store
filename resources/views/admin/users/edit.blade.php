...
@section('page_title' , @trans('common.change_password'))
@section('breadcrumb')
...
@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid form-intervale-top">
        <div class="row">
            <div class="col-lg-12">
                <!--begin::Portlet-->
                    {!! Form::model($user, ['url' => route('user.update'), 'method' => 'PUT']) !!}
                    ...
                    <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                        ...
                        <div class="kt-portlet__head kt-portlet__head--lg">
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <a href="{{ route('user.index') }}" class="btn btn-clean kt-margin-r-10">
