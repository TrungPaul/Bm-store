    ...
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
        ...
        <ul class="kt-menu__nav ">
            ...
            <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                <a href="{{ route('buyer.deposit') }}" class="kt-menu__link ">
            ...
            <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                <a href="{{ route('deposit.index') }}" class="kt-menu__link ">
                    ...
                    <span class="kt-menu__link-text">History Deposit</span>
                </a>
            </li>
            <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                <a href="{{ route('buyer.bought') }}" class="kt-menu__link ">
                    <span class="kt-menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24"
                            version="1.1" class="kt-svg-icon">
                    ...
                    <span class="kt-menu__link-text">History bought</span>
                </a>
            </li>
            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                ...
                <div class="kt-menu__submenu ">
                    @php
                        $categories = \App\Models\Category::where('status', config('constants.active'))->get();
                    @endphp
